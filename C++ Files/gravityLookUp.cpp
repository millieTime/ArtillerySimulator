...
double GravityLookUp :: getGravity(double altitude) const
{
...
tableItem GravityLookUp :: searchTable(double keyNotFound) const
{
...
double GravityLookUp :: interpolate(double x0,  double y0, double x1, double y1, double toFind) const
{
   if (y1 == y0)
   {
...
bool GravityLookUp :: closeEnough(double computedValue, double hardcodeValue) const
{
