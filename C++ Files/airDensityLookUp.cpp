...
double AirDensityLookUp :: getDensity(double altitude) const
{
...
tableItem AirDensityLookUp :: searchTable(double keyNotFound) const
{
...
double AirDensityLookUp :: interpolate(double x0,  double y0, double x1, double y1, double toFind) const
{
   if (y1 == y0)
   {
...
bool AirDensityLookUp :: closeEnough(double computedValue, double hardcodeValue) const
{
